    ...
    <>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <label className="block text-sm font-semibold text-stone-700">
          ...
          <span className="mt-1 block text-xs font-normal leading-5 text-stone-500">
            Operations lead grants the widest /ops permissions, not manager workspace access.
          </span>
        </label>
      </div>
      <label className="block text-sm font-semibold text-stone-700">
      ...
      <label className="flex items-start gap-3 rounded-xl border border-emerald-100 bg-emerald-50/60 p-3 text-sm text-stone-700">
        ...
        <span>
          ...
          The employee still signs in with their own normal Halina account. This does not create an employee account.
        </span>
      </label>
    </>
  );
...
export async function DatabaseTeamManager() {
      ...
      <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-stone-500">
            Staff use their personal Halina accounts. Whitelist the account email here, assign its operations permissions, then give staff the restaurant&apos;s internally agreed 4-digit clock-in PIN.
          </p>
        </div>
      </div>
                  ...
                  <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-start">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-stone-600">
                        {member.jobTitle} · {presetLabels[member.permissionPreset]}
                      </p>
